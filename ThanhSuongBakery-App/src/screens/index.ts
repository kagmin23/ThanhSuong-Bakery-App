...
export { ProductDetailsScreen as ProductDetailsScreen } from './product/product-details/ProductDetailsScreen';
export { ProfileScreen as ProfileScreen } from './profile/ProfileScreen';
export { SaleOffScreen as SaleOffScreen } from './shop/sale-off/SaleOffScreen';
export { ShopScreen as ShopScreen } from './shop/shop/ShopScreen';
